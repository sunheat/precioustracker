...
public class PreciousItem implements Serializable {
    ...
    private PreciousCategory preciousCategory;
    private Long preciousCategory__resolvedKey;
    ...
    public PreciousItem(Long id, String name, String location, java.util.Date dateCreated, java.util.Date lastMoved, String photoFilePath, Long category) {
        this.id = id;
        this.name = name;
    ...
    public PreciousCategory getPreciousCategory() {
        Long __key = this.category;
        if (preciousCategory__resolvedKey == null || !preciousCategory__resolvedKey.equals(__key)) {
            if (daoSession == null) {
                throw new DaoException("Entity is detached from DAO context");
            }
            PreciousCategoryDao targetDao = daoSession.getPreciousCategoryDao();
            PreciousCategory preciousCategoryNew = targetDao.load(__key);
            synchronized (this) {
                preciousCategory = preciousCategoryNew;
            	preciousCategory__resolvedKey = __key;
            }
        }
        return preciousCategory;
    }

    public void setPreciousCategory(PreciousCategory preciousCategory) {
        synchronized (this) {
            this.preciousCategory = preciousCategory;
            category = preciousCategory == null ? null : preciousCategory.getId();
            preciousCategory__resolvedKey = category;
        }
    }
